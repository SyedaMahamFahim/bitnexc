      ...
      <div class="apply-content">
        ...
        <Form class="apply-form" :model="apply_form" label-position="top">
          <FormItem :label="phone">
            <Input type="text" v-model="apply_form.telno" :placeholder="noEmpty">
              <Select v-model="apply_form.areaCode" slot="prepend" style="width: 80px;border:1px solid #27313e;">
                <Option v-for="(area,index) in areas" :key="index"  :value="area.areaCode" :label="'+' + area.areaCode">
          ...
          <FormItem :label="wechat">
            <Input type="text" v-model="apply_form.wechat"></Input>
          </FormItem>
          <FormItem :label="qq">
            <Input type="text" v-model="apply_form.qq"></Input>
          </FormItem>
          <Row>
            <Col span="8">
    ...
    getAreas() {
      ...
      this.$http.post(this.host + this.api.common.area, params).then(response => {
        ...
        if(resp.data.length > 0){
          this.apply_form.areaCode = this.areas[0].areaCode;
        }
      });
    },
    islogin() {
