<template>
  <div>
    ...
    <div class="notice ws-notice">
      <Row :gutter="30">
        <Col class="notice-list" v-if="step == 0">
          <div class="main">
            <div class="list" >
              <div @click="step = 1">
            ...
            <div class="page">
              <Page :total="totalNum" :pageSize="pageSize" :current="pageNo" @on-change="loadDataPage" size="small">
              </Page>
            </div>
          </div>
        </Col>
        ...
        this.$http
          ...
          .then(response => {
            ...
            if (result.code == 0) {
              ...
              window.document.title = (this.lang == "简体中文" ? "公告 - " : "Announcement - ") + this.data.info.title + " - BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            } else {
