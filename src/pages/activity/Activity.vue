                          ...
                          <Row class="bottom-panel">
                              <Col span="24">
                                <div class="bottom">
                                    ...
                                    <router-link :to="'/lab/detail/'+ item.id">
                                      <Button v-if="item.step==1" type="warning" @click="" target="_blank">{{$t('activity.viewdetail')}}</Button>
                                      <Button v-else type="primary" target="_blank">{{$t('activity.viewdetail')}}</Button>
                                    </router-link>
                                </div>
                                <div class="bottom-mobile">
                                    <p><span><Icon type="md-information-circle" /> {{item.detail}}</span></p>
                                    <router-link :to="'/lab/detail/'+ item.id">
                                      <Button v-if="item.step==1" long type="warning">{{$t('activity.viewdetail')}}</Button>
                                      <Button v-else type="primary" long>{{$t('activity.viewdetail')}}</Button>
                                    </router-link>
                                </div>
                              </Col>
                          </Row>
