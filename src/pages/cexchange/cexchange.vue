                        ...
                        <div class="bd bd_limited">
                          <div style="min-height: 65px;width:100%;margin-bottom: 30px;padding: 10px 10px;border-radius: 5px;background: #0b1520;">
                            <div style="width:50%;float:left;">
                              <h3>{{totalSupply}} BXT</h3>
                              <p>{{$t('cexchange.restricted')}}</p>
                            </div>
                            <div style="width:50%;float:left;">
                              <h3>1 BXT ≈ {{currentPriceShow}} {{baseCoinUnit}}</h3>
                          ...
                          <Form style="width: 60%;margin-left:20%;">
                            <FormItem class="buy-input">
                              ...
                              <div class="quantity-group">
                                <div :class="{ 'quantity-item': true, 'current': currentType == 1 }" @click="selectCount(1500, 1)"> 1500 BXT</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 2 }" @click="selectCount(1000, 2)">1000 BXT</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 3 }" @click="selectCount(500, 3)">500 BXT</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 4 }" @click="selectCount(150, 4)">150 BXT</div>
                            ...
                            <FormItem class="trade-input">
                              ...
                              <RadioGroup v-model="baseCoinUnit" style="text-align:left;margin-left:215px;float:left;">
                                  <div><Radio label="USDT" style="margin-bottom:10px;" >
                                    ...
                                    <span style="margin-left: 20px;">1 USDT ≈ {{usdtRate}} BXT</span>
                                  </Radio><br/></div>
                                  <div><Radio label="BTC" style="margin-bottom:10px;">
                                    ...
                                    <span style="margin-left: 20px;">1 BTC ≈ {{btcRate}} BXT</span>
                                  </Radio><br/></div>
                                  <div><Radio label="ETH">
                                    ...
                                    <span style="margin-left: 20px;">1 ETH ≈ {{ethRate}} BXT</span>
                                  </Radio><br/></div>
                              </RadioGroup>
                            </FormItem>
                            <FormItem>
