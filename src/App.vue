      ...
      <div class="footer_content">
        ...
        <div class="footer_right">
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/helpdetail?cate=6&id=323266">{{$t("footer.gywm")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=6&id=323265&cateTitle=其他">{{$t("footer.jrwm")}}
              </router-link>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=323261&cateTitle=条款协议">{{$t("footer.mztk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=323262&cateTitle=条款协议">{{$t("footer.ystk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=323263&cateTitle=条款协议">{{$t("footer.fwtk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=323264&cateTitle=条款协议">{{$t("footer.fltk")}}
              </router-link>
            </li>
          </ul>
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@bitnexc.com</p>
                </div>
              </poptip>
            </li>
          </ul>
    ...
    watch: {
      activeNav: function () {
        switch (this.activeNav) {
          case "nav-exchange":
            window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - BitNexc | BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          case "nav-service":
            window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - BitNexc | BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          case "nav-about":
            window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - BitNexc | BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          case "nav-lab":
            window.document.title = (this.lang == "简体中文" ? "创新实验室" : "Lab") + " - BitNexc | BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          case "nav-invite":
            window.document.title = (this.lang == "简体中文" ? "推广合伙人" : "Promotion") + " - BitNexc | BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          case "nav-cexchange":
            window.document.title = (this.lang == "简体中文" ? "活动" : "Activity") + " - BitNexc | 全球比特币交易平台 | 全球数字货币交易平台";
            break;
          default:
            window.document.title = "BitNexc | BitNexc官网 - 全球比特币交易平台 | 全球数字货币交易平台";
            break;
        }
      },
      $route(to, from) {
