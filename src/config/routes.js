...
export default [
    ...
    { path: '*', component: resolve=>(require(["../pages/index/index"],resolve)) },
    { path: '/mlab', component: resolve=>(require(["../pages/mactivity/Activity"],resolve)) },
    { path: '/mlab/detail/:id', component: resolve=>(require(["../pages/mactivity/ActivityDetail"],resolve)) },
