module.exports = {
    appmain:{
        ...
        "Revoke" :"Revoke",
        "Cancel" :"Cancel",
        "RevokeText" :" Do you confirm the cancellation of the order?",
        "Openlong" :"Open long",
        ...
        "Fund" :"Fund",
        "MyTrigger" :"My Trigger",
        "SecuritySettings" :"Security Settings",
        "Personalinfo" :"Personal info",
        "income" :"income",
        "Rewards" :"Rewards",
        "Invitaionlink" :"Invitaion link",
        ...
        "Signout" :"Sign out",
        "SecuritySettings" :"Security Settings",
        "SecuritySettingsText" :"To ensure the security of your account, please complete the real-name authentication before trading operations !",
        ...
        "WithdrawText1" :"Does not support Deposit & Witdraw",
        ...
        "Recharge" :"Recharge",
        "RechargeText" :" Choose network to get deposit address",
        "Network" :"Network",
        "Choosenetwork" :"Choose network",
        "BinanceSmartText" :"No BSC Binance Smart Chain(BEP20) deposit addresses have been applied for before. Please retrieve the deposit address.",
        "Address" :"Address",
        "DepositAddress" :"Deposit Address",
        "NetworkText" :"   Ensure the network you choose to deposit mathches the withdrawal network,or assets may be lost ",
        "DepositrecordFIL" :"Deposit record FIL",
    ...
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "Global digital currency trading platform",
        subslogan: "Gather innovative digital assets",
        more: "More",
        please: "Please",
        pleaseselect: "Select",
        ...
        close: "Close",
        ok: "OK",
        footer1: "Trading responsibilities: BitNexc does not suggest any financial product mentioned in this advertisement, mail or related website, and the information contained does not take into account your personal goals, financial situation and needs. Therefore, considerations should be made regarding whether the products are compatible with your goals, financial situations and needs, and also the potential risks during trading. Before making any decisions related to BitNexc products, it is recommended that you read the regulations regarding Customer Funds Protection. Foreign exchange transactions involve significant risk of loss. Invest funds on your own risk.",
        footer2: "BitNexc Cryptocurrency Exchange platform is based in 296 High Holborn, London, United Kingdom with the authorized and regulated by the Money Services Businesses (MSBs).",
        footer3: "Copyright © 2020 BitNexc | All Rights Reserved | MSB Registration Number: 31000177125866",
    },
    header: {
        index: 'Home',
        otc: 'OTC',
        ...
        lab: "Launchpad",
        ctc: "C2C Exchange",
        labdetail: "BitNexc Lightning Lab",
    ...
    sectionPage: {
        ...
        brandTitle: "About BitNexc",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "BitNexc's core mission is to provide safe, fair and easy-to-use digital asset trading services to provide a reliable and comfortable investment trading environment for global digital asset trading users.",
        brandDesc2: "The field of digital assets changes with each passing day. Only with foresight and swift progress can we keep up with the rapid technological innovation. BitNexc provides our users and global investors with the most advanced digital asset trading services and businesses.",
        ...
        officialstart: "BitNexc Official Customer Service",
        oneminutebuy: "What is cryptocurrency",
        oneminutebuytips: "The History of Cryptocurrency",
        baseknow: "BitNexc Beginners Guide",
        baseknowtips: "How to Start your Journey",
        baseexchange: "Introduction of Digital Assets",
        baseexchangetips: "Crypto Fundamentals",
        usersocial: "License",
        usersocialtips: "Official Permission",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by BitNexc, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of BitNexc.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（BitNexc）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with BitNexc trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1. In order to preach the concept of digital assets and expand the scale of users, BitNexc launched the [Promotion Partner] plan, which is effective for a long time.",
        ruletext2: "2. Inviting friends is divided into two levels. If A invites B, then B is A's first-level friend. If B invites C, then C belongs to B's first-level friend and also belongs to A's second-level friend.",
        ...
        ruletext8: "7. The TOP10 or TOP100 of the promotion rebate rankings will receive additional rewards from BitNexc from time to time.",
        ...
        ruletext10: "",
        ruletext11: "9. The final interpretation right of this event belongs to BitNexc.",
        ...
        thanks: "Thank you for supporting BitNexc！",
        ...
        pt_tips: "If you have a good idea, please send an email to support@BitNexc.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to BitNexc.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        safe: {
            ...
            idcard_verifymsg3: "3. Need to hold both hand-held documents and handwritten copy (BitNexc+name + application date), 'All my actions on this site are my own operations, and I understand the risks involved and willing to bear all the legal consequences of this account.'"
        },
        account: {
    ...
    description: {
        title1: 'One-stop service',
        title2: 'Trusted Exchange',
        title3: 'Security',
        title4: 'Fast Transaction',
        message1: 'BitNexc has the world\'s top industry resources, aggregates high-quality blockchain system assets, committed to building the world\'s top cryptocurrency exchange',
        message2: 'BitNexc is a reliable, comfortable, safe, transparency, and fair easy-to-use trading exchange that strictly follow the industry rules',
        message3: 'BitNexc have created a top-level security risk control system and used different security designs to escort every investor wallet',
        message4: 'BitNexc has the long-standing technical accumulation provides users with an efficient and convenient real-time trading system',
        scanqrcode: "Scan QR code, Download APP",
        aboutdesc1: "BitNexc's core mission is to provide safe, fair and easy-to-use digital asset trading services to provide a reliable and comfortable investment trading environment for global digital asset trading users.",
        aboutdesc2: "The field of digital assets changes with each passing day. Only with foresight and swift progress can we keep up with the rapid technological innovation. BitNexc provides our users and global investors with the most advanced digital asset trading services and businesses.",
        aboutdesc3: "BitNexc has established a solid and reliable foundation and is ready for future development. We will focus on the advantages of more digital financial systems on the platform, and provide users around the world with digital subscriptions, legal currency, currency and financial derivatives and other digital transactions. Service, and continuity to bring a new experience to users. ",
        support: "Support",
        report: "Suggestion",
        ...
        instagram: "Instagram",
        reddit: "Reddit",
        download1: "Trade Anywhere Anytime",
        download2: "Any device at any time, trade on the go",
    },
    bzb_description: {
        title1: "",
        title2: "",
