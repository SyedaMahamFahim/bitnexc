module.exports = {
    appmain: {
        ...
        "Signout": "登出",
        "SecuritySettings": "安全設置",
        "SecuritySettingsText": "為確保您的帳戶安全，請在交易操作前完成實名認證！",
        ...
        "InOrder": "有序",
        "Tobereleased": "待發佈",
        "WithdrawText1": "不支援 Deposit & Witdraw",
        "Assettransfer": "資產轉移",
        "From": "從",
        "To": "自",
        "Balance": "平衡",
        ...
        "Freezemargin": "凍結保證金",
        "Recharge": "充值",
        "RechargeText": "選擇網路以獲取存款位址",
        "Network": "網路",
        "Choosenetwork": "選擇網路",
        "BinanceSmartText": "之前沒有申請過BSC幣安智慧鏈（BEP20）存款位址。請找回存款位址。",
        "Address": "位址",
        "DepositAddress": "存款位址",
        "NetworkText": "確保您選擇存入的網路與提款網路相結合，否則資產可能會丟失",
        "DepositrecordFIL": "存款記錄 FIL",
        "Arrivaltime": "到達時間",
        "Hash": "散列",
        "Withdrawalrecord": "提款記錄",
        "Withdrawal": "提款",
        "Withdrawaladdress": "提款位址",
        "Arrivalquantity": "到達數量",
        "Submit": "提交"
    },
    common: {
        login: '登录',
        ...
        close: "关闭",
        ok: "确定",
        footer1: "交易职责： 在这则广告、邮件及其相关网站中提及的任何金融产品，BitNexc 都不做出任何建议，同时包含的信息不考虑您的个人目标、财务状况和需求。因此，您需要考虑这些产品是否符合您的目标、财务状况和需求，并同时考虑与交易这些产品相关的风险。在做出任何与 BitNexc 产品相关的决定之前，建议您阅读条规以及客户资金保护。外汇交易涉及重大的损失风险。请勿投入超出您的损失承受范围的资金",
        footer2: "BitNexc 数字资产交易平台位于 296 High Holborn, London, United Kingdom 授权于美国金融监管局MSB监管",
        footer3: "Copyright © 2020 BitNexc | 版权所有 | 货币服务业务（MSB）注册号：31000177125866",
    },
    header: {
        index: '首页',
        exchange: '币币交易',
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于BitNexc",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "BitNexc榜利以安全，公平，易用的数字资产交易服务为核心使命，为全球数字资产交易用户提供可信赖的舒适投资交易环境。",
        brandDesc2: "数字资产领域日新月异，唯有高瞻远瞩、迅捷前行才能跟上迅猛的科技创新，BitNexc榜利为我们的用户及全球投资者提供最先进的数字资产交易服务以及业务。",
        brandDesc3: "BitNexc 榜利建立了坚实可靠的基础，为未来的发展做好准备，我们将会聚焦更多数字金融体系的优势于平台，为全球用户提供数字申购，法币，币币及金融衍生品等数字交易服务，并持续性为用户带来全新体验。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "BitNexc官方新手入门辅助通道",
        oneminutebuy: "什么是加密货币",
        oneminutebuytips: "加密货币的历史",
        baseknow: "榜利新用户指引",
        baseknowtips: "如何开始你的旅程",
        baseexchange: "数字资产介绍",
        baseexchangetips: "加密货币基础",
        usersocial: "领有牌照",
        usersocialtips: "官方许可",
        mainboard: "主板交易区",
        preview: "上一页",
    ...
    ctc: {
        ...
        desc: "由BitNexc平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归BitNexc官方所有",
        inputamount: "输入兑换数量",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1: "BitNexc的【推广合伙人】是全网",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣时长最长(最高终身返佣)",
        ruleprofile4: "的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与BitNexc交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，BitNexc推出【推广合伙人】计划，该活动长期有效。",
        ...
        ruletext8: "七、推广返佣排行榜TOP10或TOP100不定期会获得由BitNexc官方发放的额外奖励。",
        ruletext9: "八、如其他活动与【推广合伙人】活动冲突，则经协商后决定是否临时变更，望诸合伙人谅解。",
        ruletext10: "",
        ruletext11: "九、本活动最终解释权归BitNexc所有。",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由BitNexc官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归BitNexc所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        safe: {
            ...
            idcard_verifymsg3: "3、需要同时手持证件和手写文案（BitNexc+姓名+申请日期）'我在本站的所有行为均为本人操作，并已知悉相关风险，愿意承担本账户的一切法律后果。'"
        },
        account: {
            pagetitle: '绑定实名帐号',
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "BitNexcAPP - 全球数字资产交易平台"
    },
    description: {
        title1: '一站式服务',
        title2: '您可信赖的平台',
        title3: '安全防护',
        title4: '快捷的交易充提系统',
        message1: '整合全球顶级行业资源，聚合优质区块链资产，致力于打造全球顶级的数字资产交易所',
        message2: '秉持核心价值严格遵循行业规则，不参与市场运作。公开、透明、平等、合作一直是我们坚持的使命',
        message3: '凭借在数字行业的丰富经验，专门打造顶级安全风控体系，采用不同安全设计为每一位投资者保驾护航',
        message4: '榜利经久的技术积淀，为您提供了高效便捷的实时交易系统。您的资金出入亦可秒冲秒提',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "BitNexc榜利以安全，公平，易用的数字资产交易服务为核心使命，为全球数字资产交易用户提供可信赖的舒适投资交易环境。",
        aboutdesc2: "数字资产领域日新月异，唯有高瞻远瞩、迅捷前行才能跟上迅猛的科技创新，BitNexc榜利为我们的用户及全球投资者提供最先进的数字资产交易服务以及业务。",
        aboutdesc3: "BitNexc 榜利建立了坚实可靠的基础，为未来的发展做好准备，我们将会聚焦更多数字金融体系的优势于平台，为全球用户提供数字申购，法币，币币及金融衍生品等数字交易服务，并持续性为用户带来全新体验。",
        support: "技术支持",
        report: "投诉建议",
        service: "客户服务",
        apply: "上币申请",
    ...
    bzb_description: {
        ...
        desc4: "参与BitNexc社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "BitNexc账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于BitNexc收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，BitNexc会拿出平台的80% (扣除税费后) 的收入分配给BitNexc持有者，20%的收入用来支持平台的研发及运营。",
