module.exports = {
    ...
    common: {
        ...
        close: "關閉",
        ok: "確定",
        footer1: "交易職責： 在這則廣告、郵件及其相關網站中提及的任何金融產品，BitNexc 都不做出任何建議，同時包含的信息不考慮您的個人目標、財務狀況和需求。因此，您需要考慮這些產品是否符合您的目標、財務狀況和需求，並同時考慮與交易這些產品相關的風險。在做出任何與 BitNexc 產品相關的決定之前，建議您閱讀條規以及客戶資金保護。外匯交易涉及重大的損失風險。請勿投入超出您的損失承受範圍的資金",
        footer2: "BitNexc 數字資產交易平台位於 296 High Holborn, London, United Kingdom 授權於美國金融監管局MSB監管",
        footer3: "Copyright © 2020 BitNexc | 版權所有 | 貨幣服務業務（MSB）註冊號：31000177125866",
    },
    header: {
        index: "首頁",
        exchange: "幣幣交易",
    ...
    sectionPage: {
        ...
        newsTitle: "多終端APP",
        brandTitle: "關於BitNexc",
        brandDetail: "誠實 | 公平 | 熱情 | 開放",
        brandDesc1: "BitNexc榜利以安全，公平，易用的數字資產交易服務為核心使命，為全球數字資產交易用戶提供可信賴的舒適投資交易環境。",
        brandDesc2: "數字資產領域日新月異，唯有高瞻遠矚、迅捷前行才能跟上迅猛的科技創新，BitNexc榜利為我們的用戶及全球投資者提供最先進的數字資產交易服務以及業務。",
        brandDesc3: "BitNexc 榜利建立了堅實可靠的基礎，為未來的發展做好準備，我們將會聚焦更多數字金融體系的優勢於平台，為全球用戶提供數字申購，法幣，幣幣及金融衍生品等數字交易服務，並持續性為用戶帶來全新體驗。",
        gettingstart: "新手入門 | 極速買幣",
        officialstart: "BitNexc官方新手入門輔助通道",
        oneminutebuy: "什麼是加密貨幣",
        oneminutebuytips: "加密貨幣的歷史",
        baseknow: "榜利新用戶指引",
        baseknowtips: "如何開始你的旅程",
        baseexchange: "數字資產介紹",
        baseexchangetips: "加密貨幣基礎",
        usersocial: "領有牌照",
        usersocialtips: "官方許可",
        mainboard: "主板交易區",
        preview: "上一頁",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴BitNexc的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴BitNexc交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，BitNexc推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        ruletext8: "七、推廣返佣排行榜TOP10或TOP100不定期會獲得由BitNexc官方發放的額外獎勵。",
        ruletext9: "八、如其他活動與【推廣合夥人】活動衝突，則經協商後決定是否臨時變更，望諸合夥人諒解。",
        ruletext10: "",
        ruletext11: "九、本活動最終解釋權歸BitNexc所有。",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴BitNexc官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
        ...
        pt_card_rule6: "六、免費禮品卡最終解釋權歸BitNexc所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        safe: {
            ...
            idcard_verifymsg3: "3、需要同時手持證件和手寫文案（BitNexc+姓名+申請日期）'我在本站的所有行為均為本人操作，並已知悉相關風險，願意承擔本賬戶的一切法律後果。 '"
        },
        account: {
            pagetitle: "綁定實名帳號",
    ...
    description: {
        ...
        title3: '安全防護',
        title4: '快捷的交易充提系統',
        message1: '整合全球頂級行業資源，聚合優質區塊鏈資產，致力於打造全球頂級的數字資產交易所',
        message2: '秉持核心價值嚴格遵循行業規則，不參與市場運作。公開、透明、平等、合作一直是我們堅持的使命',
        message3: '憑藉在數字行業的豐富經驗，專門打造頂級安全風控體系，採用不同安全設計為每一位投資者保駕護航',
        message4: '榜利經久的技術積澱，為您提供了高效便捷的實時交易系統。您的資金出入亦可秒衝秒提',
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "BitNexc榜利以安全，公平，易用的數字資產交易服務為核心使命，為全球數字資產交易用戶提供可信賴的舒適投資交易環境。",
        aboutdesc2: "數字資產領域日新月異，唯有高瞻遠矚、迅捷前行才能跟上迅猛的科技創新，BitNexc榜利為我們的用戶及全球投資者提供最先進的數字資產交易服務以及業務。",
        aboutdesc3: "BitNexc 榜利建立了堅實可靠的基礎，為未來的發展做好準備，我們將會聚焦更多數字金融體系的優勢於平台，為全球用戶提供數字申購，法幣，幣幣及金融衍生品等數字交易服務，並持續性為用戶帶來全新體驗。",
        support: "技術支持",
        report: "投訴建議",
        service: "客戶服務",
        apply: "上幣申請",
        ...
        community: "幣嚴社區",
        wechat: "微信",
        addwechat: "添加 “BitNexc01” 為微信好友，進入微信福利社群",
        facebook: "面子書",
        weibo: "微博",
        twitter: "推特",
        biyong: "幣用",
    ...
    bzb_description: {
        ...
        desc4: "參與BitNexc社區投票活動，包括但不限於上幣、回購等",
    ...
    index: {
        ...
        BHBregister: "BitNexc賬戶註冊",
        tibi: "提幣到賬時間及限額",
        line_plane: "BHB上線計劃、流通量及手續費返還公告",
        fenpeijizhi: "關於BitNexc收入分配機制的說明",
        jiangli_jihua: "邀請挖礦獎勵計劃",
        friend_fanhuan: "邀請好友、賺取額外手續費返還"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者權益)",
        content1: "正如白皮書所描述的，BitNexc會拿出平台的80% (扣除稅費後) 的收入分配給BitNexc持有者，20%的收入用來支持平台的研發及運營。",
