<template>
  <div>
    <!-- <div class="nav-rights safe d-none">
          ...
          <div class="rightarea-con">
            <div class="user-top-icon">
              ...
              <Row class="user-right">
                ...
                <i class="m3"></i>
                <div class="itp" v-if="user.realVerified==0&&user.phoneVerified==0&&user.fundsVerified==0">
                  {{$t('uc.safe.safelevel_low')}}</div>
                <div class="itp" v-else-if="user.realVerified==1&&user.phoneVerified==1&&user.fundsVerified==1">
                  {{$t('uc.safe.safelevel_high')}}</div>
              ...
              <div class="account-in">
                ...
                <div class="account-item">
                  <div class="account-item-in">
                    ...
                    <p v-if="user.realVerified==1" class="bankInfo" style="color: #fff;font-size: 13px;">
                      {{user.realName}}
                    </p>
                    <p v-else-if="user.realVerified==0&&user.realAuditing==0&&user.realNameRejectReason!=null"
                      class="bankInfo" style="color: #f0a70a;font-size: 13px;">
                    ...
                    <div class="detail-list" style="width: 100%;">
                      <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85"
                        ...
                        <FormItem style="text-align:center;">
                          <Button type="warning" @click="handleSubmit('formValidate6')"
                            style="margin-left: -85px;">{{$t('uc.safe.save')}}</Button>
                          <Button @click="handleReset('formValidate6')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
                  </div>
                    ...
                    <div class="detail-list">
                      <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="110">
                        ...
                        <FormItem>
                          ...
                          <Button @click="handleReset('formValidate2')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
                      ...
                      <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="110">
                        <FormItem :label="$t('uc.safe.phone')" prop="mobile">
                          ...
                          <Select v-model="country" slot="prepend" style="width: 80px;border:1px solid #27313e;">
                            <Option v-for="(area,index) in areas" :key="index" :value="area.zhName"
                              :label="'+' + area.areaCode">
                        ...
                        <FormItem>
                          ...
                          <Button @click="handleReset('formValidate3')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
                    ...
                    <div class="detail-list">
                      <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate" :label-width="95">
                        ...
                        <FormItem>
                          ...
                          <Button @click="handleReset('formValidate4')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
                    ...
                    <div class="detail-list" v-show="user.fundsVerified!=1">
                      <Form ref="formValidate7" :model="formValidate7" :rules="ruleValidate" :label-width="85">
                        ...
                        <FormItem>
                          ...
                          <Button @click="handleReset('formValidate7')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
                    ...
                    <div class="detail-list" v-show="user.fundsVerified==1 && fGetBackFundpwd">
                      <Form ref="formValidate8" :model="formValidate8" :rules="ruleValidate" :label-width="85">
                        ...
                        <FormItem>
                          ...
                          <Button @click="handleReset('formValidate8')"
                            style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                        </FormItem>
                      </Form>
                    </div>
