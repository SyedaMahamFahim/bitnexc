          ...
          <div class="table-inner">
            ...
            <div class="action-content">
              <div class="action-body">
                <p class="acb-p1 describe">{{$t('uc.finance.withdraw.withdrawcodelist')}}{{dataCount}}</p>
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            if (params.row.status == 0) {
              text = this.$t("uc.finance.withdraw.code_status0");
            } else {
              text = this.$t("uc.finance.withdraw.code_status3");
            }
            return h("span", text);
          }
        }
      ...
      this.$http
        ...
        .then(response => {
          ...
          if (resp.code == 0 && resp.data.content) {
            this.dataWithdrawCodeList = resp.data.content;
